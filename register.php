	...
	<body>
		...
		<section id="register" class="section-overlay">
			...
			<div class="container center">
				<h2>¿Ya estás registrado? <a href="log-in " class="link">Ingresa aquí.</a></h2>
				...
				<br>
				<a href="request " class="middle button button--tamaya button--border-thick" data-text="Regístrate"><span>Regístrate</span></a>
			</div>
		</section>
